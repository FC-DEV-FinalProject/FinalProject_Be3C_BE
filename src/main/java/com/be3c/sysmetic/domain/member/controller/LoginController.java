...
import com.be3c.sysmetic.domain.member.dto.LoginResponseDto;
...
public class LoginController {
    ...
    @PostMapping("/auth/login")
        public ResponseEntity<ApiResponse<String>> login(@Valid @RequestBody LoginResponseDto requestDto, HttpServletResponse response) {
