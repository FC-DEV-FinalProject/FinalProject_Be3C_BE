...
public class AdminMainServiceImpl implements AdminMainService {
    ...
    public AdminMainResponseDto getAdminMain() {
        ...
        return AdminMainResponseDto.builder()
                .runReportResponseDto(RunReportResponseDto.builder()
                ...
                .memberCount(MemberCountResponseDto.builder()
                        ...
                        .build())
                .adminNoticeResponse(noticeRepository.findAdminMainNotice(pageable).getContent())
                .adminInquiryResponseDto(AdminInquiryResponseDto.builder()
    ...
    private MemberCountResponseDto getMemberRatio() {
        return MemberCountResponseDto.builder()
                ...
                .TraderMemberCount(memberRepository.countTrader())
                .userMemberCount(memberRepository.countUser())
                .build();
    }
}